...
descriptionElement.innerHTML = 'JSで変更した後の<strong>説明文</strong>';
  ...
  */
const profileImgElement = document.getElementById('profile');
profileImgElement.setAttribute('src', 'https://www.pakutaso.com/shared/img/thumb/TOMnemuiDSC01757_TP_V1.jpg');
